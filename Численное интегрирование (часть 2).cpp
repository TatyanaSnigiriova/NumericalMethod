...
int main()
{
	...
	cout << "	Данная программа вычисляет приближенные значения интеграла для заданной функции ( в данном случае " << getF() << " ) методом Симпсона.\n";
	cout << " Для работы с другими функциями, впишите их в 'F' и задайте текстовое представление в 'getF', а также занесите её четвертую производную в 'FFourthDerivative' перед функцией 'main'.\n Четвертая производная используется для оценки погрешности.\n\n";
